...
`;
    ...
    function apply(ctx) {
      ...
      // active-theme styles — swapped on applyTheme(); reuse an existing
      // element so HMR re-applies never stack duplicate <style> nodes.
      themeStyleEl = document.getElementById("dsh-theme-active-style");
      if (!themeStyleEl) {
